      ...
      <main className="max-w-2xl mx-auto mt-6 px-4">
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="pt-4 flex justify-between">
              <button
                onClick={() => setStep(1)}
                className="px-6 py-3.5 border border-pink-200 bg-white/90 text-gray-800 font-bold text-sm rounded-xl hover:bg-pink-50 transition-colors shadow-sm"
              >
                Back
              </button>
              <button
        ...
        {step === 3 && (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Summary Preview */}
            <div className="bg-white/90 border border-pink-100/70 rounded-2xl p-4 text-xs space-y-3 shadow-sm">
